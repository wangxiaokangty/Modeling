...
from dataloaders.vanilla_slam_loaders import YearOpenSplitDataSet
...
def test_my_model(save_path, test_slam_years, model_info, device):
	...
	test_slam_years=['2014-ausopen','2014-frenchopen', '2014-usopen', '2014-wimbledon', '2022-usopen', '2022-wimbledon', '2023-usopen', '2023-wimbledon']
